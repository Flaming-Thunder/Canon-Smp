...
execute as @s run %FILE%/loop {Update:11}
...
/loop
  ...
  execute if score Player.Teams.Update Game.Data matches -11..10 run %FILE%/loop with storage game:data Data.Player.Teams
...
execute as @s if score @s Player.Lives matches 0 run
  attribute @s entity_interaction_range base set 2.75
...
execute as @s if score @s Player.Lives matches -2 run
  attribute @s entity_interaction_range base set 2.25
...
execute as @s if score @s Player.Lives matches -4 run
  attribute @s entity_interaction_range base set 1.90
...
execute as @s if score @s Player.Lives matches -9 run
  attribute @s entity_interaction_range base set 1.4
...
execute as @s if score @s Player.Lives matches ..-10 run
  attribute @s entity_interaction_range base set 1.3
