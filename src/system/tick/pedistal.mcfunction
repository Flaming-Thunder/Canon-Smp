...
execute at @s run fill ~ ~ ~ ~ ~ ~ air destroy

execute if block ~ ~-1 ~ #air run %FILE%/remove
...
execute unless score @s Altar.LockDelay matches 1.. on passengers if entity @s[type=interaction] run
  ...
  execute if score .temp0 Game.Math matches 1 on vehicle if score .haveItem Game.Math matches 1 run %FILE%/drop_item
  ...
  execute if data entity @s interaction if data storage game:math temp.item2 on vehicle if score .haveItem Game.Math matches 1 run %FILE%/drop_item
  execute if data entity @s interaction if data storage game:math temp.item2 on vehicle on passengers if entity @s[type=item_display] run
...
/init
  execute if entity @s[tag=Magic.Simple] align xyz unless entity @a[dx=0,dz=0,dy=0,gamemode=!spectator] positioned ~0.5 ~ ~0.5 unless entity @e[type=item_display,tag=Magic.Pedestal,distance=..0.51] run
    execute if entity @s[tag=Magic.Altar] run summon item_display ~ ~ ~ {Tags:["Magic.Pedestal","Magic.Simple","Magic.Altar"],brightness:{block:15,sky:15},item:{id:"nether_star",components:{"!enchantment_glint_override":{},"custom_model_data":{strings:["1 Altar"]}}},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[1,1,1],translation:[0,0.5,0]},Passengers:[{id:"item_display",brightness:{block:15,sky:15},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[0.5,0.5,0.5],translation:[0,1.25,0]},teleport_duration:1},{id:"interaction",width:1,height:1.1}]}
    execute if entity @s[tag=!Magic.Altar] run summon item_display ~ ~ ~ {Tags:["Magic.Pedestal","Magic.Simple"],brightness:{block:15,sky:15},item:{id:"nether_star",components:{"!enchantment_glint_override":{},"custom_model_data":{strings:["1 Pedistal"]}}},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[1,1,1],translation:[0,0.5,0]},Passengers:[{id:"item_display",brightness:{block:15,sky:15},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[0.5,0.5,0.5],translation:[0,1.25,0]},teleport_duration:1},{id:"interaction",width:1,height:1.1}]}
  ...
  execute if entity @s[tag=Magic.Basic] align xyz unless entity @a[dx=0,dz=0,dy=0,gamemode=!spectator] positioned ~0.5 ~ ~0.5 unless entity @e[type=item_display,tag=Magic.Pedestal,distance=..0.51] run 
    execute if entity @s[tag=Magic.Altar] run summon item_display ~ ~ ~ {Tags:["Magic.Pedestal","Magic.Basic","Magic.Altar"],brightness:{block:15,sky:15},item:{id:"nether_star",components:{"!enchantment_glint_override":{},"custom_model_data":{strings:["2 Altar"]}}},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[1,1,1],translation:[0,0.5,0]},Passengers:[{id:"item_display",brightness:{block:15,sky:15},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[0.5,0.5,0.5],translation:[0,1.25,0]},teleport_duration:1},{id:"interaction",width:1,height:1.1}]}
    execute if entity @s[tag=!Magic.Altar] run summon item_display ~ ~ ~ {Tags:["Magic.Pedestal","Magic.Basic"],brightness:{block:15,sky:15},item:{id:"nether_star",components:{"!enchantment_glint_override":{},"custom_model_data":{strings:["2 Pedistal"]}}},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[1,1,1],translation:[0,0.5,0]},Passengers:[{id:"item_display",brightness:{block:15,sky:15},transformation:{left_rotation:[0,0,0,1],right_rotation:[0,0,0,1],scale:[0.5,0.5,0.5],translation:[0,1.75,0]},teleport_duration:1},{id:"interaction",width:1,height:1.6}]}
    summon block_display ~ ~ ~ {Tags:["Magic.PedestalHitbox"],Passengers:[{id:"shulker",PersistenceRequired:1b,attributes:[{id:"scale",base:0.875}],Silent:1b,Invulnerable:1b,DeathLootTable:"",NoAI:1b,active_effects:[{id:"invisibility",amplifier:255,duration:-1,show_particles:false}]}]}
