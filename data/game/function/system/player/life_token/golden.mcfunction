execute as @s if score @s Player.Lives matches 15.. run function game:system/player/life_token/golden/supermaxxed
execute as @s if score @s Player.Lives matches 10..14 run function game:system/player/life_token/golden/maxed
