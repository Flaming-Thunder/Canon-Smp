...
execute if score @s Altar.LockDelay matches 0 if data entity @s data.loot at @s positioned ~ ~4 ~ if data entity @s data.loot run function game:system/tick/pedistal/craft_result with entity @s data
execute if score @s Altar.LockDelay matches 0 if data entity @s data.loot at @s positioned ~ ~4 ~ if data entity @s data.cmd run function game:system/tick/pedistal/craft_function with entity @s data
