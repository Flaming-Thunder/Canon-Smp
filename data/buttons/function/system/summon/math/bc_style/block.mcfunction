...
execute store result storage buttons:storage temp.w0 float 0.005555 run data get storage buttons:storage temp.w 100
execute store result storage buttons:storage temp.w1 float 0.003333 run data get storage buttons:storage temp.w 100
execute store result storage buttons:storage temp.w2 float 0.005000 run data get storage buttons:storage temp.w 100
execute store result storage buttons:storage temp.w3 float 0.002777 run data get storage buttons:storage temp.w 100
execute store result storage buttons:storage temp.w4 float 0.001666 run data get storage buttons:storage temp.w 100

execute store result storage buttons:storage temp.h0 float 0.003333 run data get storage buttons:storage temp.h 100
execute store result storage buttons:storage temp.h1 float 0.011666 run data get storage buttons:storage temp.h 100
...
execute if score .temp0 buttons.main matches 0 run function buttons:system/summon/cta0 with storage buttons:storage temp
execute if score .temp0 buttons.main matches 1 run function buttons:system/summon/cta0_icon with storage buttons:storage temp

tellraw @a {nbt:"temp",storage:"buttons:storage"}
