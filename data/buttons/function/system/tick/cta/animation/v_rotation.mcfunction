...
execute if score @s buttons.main = .temp1 buttons.main at @s run rotate @s ~90 ~
execute if score @s buttons.main = .temp1 buttons.main on passengers if entity @s[tag=button.text,type=text_display] at @s run rotate @s ~90 ~
execute if score @s buttons.main = .temp1 buttons.main on passengers if entity @s[tag=button.border,type=text_display] at @s run rotate @s ~90 ~
execute if score @s buttons.main = .temp1 buttons.main on passengers if entity @s[tag=button.icon,type=item_display] at @s run rotate @s ~90 ~

execute if score @s buttons.main matches 0 at @s run rotate @s ~90 ~
execute if score @s buttons.main matches 0 on passengers if entity @s[tag=button.text,type=text_display] at @s run rotate @s ~90 ~
execute if score @s buttons.main matches 0 on passengers if entity @s[tag=button.border,type=text_display] at @s run rotate @s ~90 ~
execute if score @s buttons.main matches 0 on passengers if entity @s[tag=button.icon,type=item_display] at @s run rotate @s ~90 ~
