...
#execute if data entity @s attack run function buttons:system/tick/hitbox/pre_plane
#execute if data entity @s interaction run function buttons:system/tick/hitbox/pre_plane
